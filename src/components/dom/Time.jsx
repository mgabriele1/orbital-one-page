...
export default function Time() {
    return (
      <div className='grid place-items-center row-start-3 sm:row-start-3 sm:col-start-1'>
        <div className="absolute z-10 p-5 w-4/5 h-1/5 flex flex-col justify-center items-center max-w-md max-h-52 min-h-125 sm:w-1/3">
        ...
        <div className="absolute z-0 w-4/5 h-1/5 max-w-md max-h-52 min-h-105 sm:w-1/3">
          <Background />
        </div>
      </div>
    )
